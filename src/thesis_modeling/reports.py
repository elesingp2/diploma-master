...
def build_energy_funnel(
    ...
    """Строит энергетическую сводку по ряду GeN-Foam."""
...
def build_pipeline_takeaways(
    ...
    """Собирает краткий расчетный вывод."""
    main_reading = []
    ...
    return {
        ...
        "missing_work": [
            ...
            "оформить материалы-кандидаты отдельной версией расчетной цепочки с проверкой нейтроники, окисления, теплового удара и радиационных ограничений",
